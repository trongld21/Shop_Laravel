...
@section('content')
    <form id="add-item" action="" method="post">
        ...
        <fieldset>
            ...
            <input placeholder="Vui lòng nhập tên: " id="menu_name" name="menu_name" type="text" tabindex="1" autofocus>
        </fieldset>
        <fieldset>
        ...
        <fieldset>
            ...
            <textarea placeholder="Vui lòng nhập mô tả: " id="description" name="description" autofocus></textarea>
        </fieldset>
        <fieldset>
            <label for="content">Nội dung:</label>
            <textarea placeholder="Vui lòng nhập nội dung: " id="content" name="content" autofocus></textarea>
        </fieldset>
        <fieldset>
            <p>Trạng thái:</p>
            <input type="radio" id="active" name="active" value="1">
            <label for="active">Yes</label><br>
            <input type="radio" id="noactive" name="active" value="0">
            <label for="noactive">No</label><br>
        </fieldset>
        <fieldset>
            <button name="submit" type="submit" id="add-item-submit">Thêm danh mục</button>
        </fieldset>
    </form>
    <script>
